...
export default function FilterControls({ effects, setEffects }: FilterControlsProps) {
  ...
  return (
    <div className="flex flex-col gap-4">
      <Accordion type="multiple">
        <AccordionItem value="master" variant="primary">
          <AccordionTrigger>Master</AccordionTrigger>
          <AccordionContent animateChildren>
            {/* Master Section */}
            <div className="flex flex-col gap-2 pr-2">
              <label className="accordion-animation-target flex items-center justify-between text-sm">
        ...
        <AccordionItem variant="primary" value="reverb">
          <AccordionTrigger>Reverb</AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem variant="primary" value="compressor">
          <AccordionTrigger>Compressor</AccordionTrigger>
          <AccordionContent>
            <div className="flex flex-col gap-2">
